...
bonus_loseHealthIMG=loadImage("heart_gone.png")
bonus_loseHealthIMG.set_colorkey(WHITE)

bonus_coinIMG=loadImage("gold-coin.png")
bonus_coinIMG.set_colorkey(BLACK)
    ...
    def hit_bonus(self):
        ...
        for bonus in hit_group:
            ...
            if (r==0):
                ...
                bonus = Bonus(bonus_coinIMG, "coin")
                spriteGroup.add(bonus)
                bonusGroup.add(bonus)
